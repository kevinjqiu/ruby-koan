...
class AboutToStr < Neo::Koan
  ...
  def test_to_str_allows_objects_to_be_treated_as_strings  # TIL: to_str allows objects to be treated as strings. This is pretty cool. Sort of like scala's implicit
