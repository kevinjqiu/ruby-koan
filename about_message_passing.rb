...
class AboutMessagePassing < Neo::Koan
  ...
  def test_methods_can_be_invoked_by_sending_the_message
    ...
    assert mc.send(:caught?)  # TIL: obj.send(:message) is another way to do obj.message
  end
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    assert_equal true, mc.__send__(:caught?)  # TIL: __send__
  ...
  def test_classes_can_be_asked_if_they_know_how_to_respond
    ...
    assert_equal false, mc.respond_to?(:does_not_exist)  # TIL: .respond_to? is a check for method existence
  end
  ...
  class AllMessageCatcher
    def method_missing(method_name, *args, &block)  # TIL: ruby "magical methods" are commonly named, like `method_missing`, `send`, etc
