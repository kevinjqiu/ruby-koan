...
class AboutSymbols < Neo::Koan
  ...
  def test_method_names_become_symbols
    symbols_as_strings = Symbol.all_symbols.map { |x| x.to_s }  # TIL: Symbol.all_symbols gets all symbols in scope
  ...
  def test_symbols_do_not_have_string_methods
    symbol = :not_a_string
    assert_equal false, symbol.respond_to?(:each_char)  # TIL: object.respond_to?
