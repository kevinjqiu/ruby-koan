...
class AboutClassMethods < Neo::Koan
  ...
  def test_you_can_define_methods_on_individual_objects
    fido = Dog.new
    def fido.wag  # TIL: def object.method defines a new method on the object
      :fidos_wag
    end
  ...
  def Dog2.wag  # TIL: this is how you define class methods
    :class_level_wag
  end
  ...
  class Dog
    def Dog.a_class_method  # TIL: define class methods inside a class
      :dogs_class_method
    end
  end
  ...
  SelfInsideOfClassStatement = class Dog  # TIL: self while inside class statement refers to the class
                                 self
                               end
  ...
  class Dog
    def self.class_method2  # TIL: a more convenient way to write class methods
  ...
  class Dog
    class << self  # TIL: another way to write class methods
  ...
  def test_heres_an_easy_way_to_call_class_methods_from_instance_methods  # TIL: call class methods from instance: instance.class.class_method
    fido = Dog.new
